...
func PostorderTraversalTwoStacks(root *TreeNode) []int {
	if root == nil {
		return []int{}
	}
...
func PostorderTraversalReversePreorder(root *TreeNode) []int {
	if root == nil {
		return []int{}
	}
...
func postorderRecursive(node *TreeNode, result *[]int) {
	if node == nil {
		return
	}
