...
func buildTreeFromInorderPostorderRecursive(inorder []int, postorder []int) *utils.TreeNode {
...
func buildTreeFromInorderPostorderOptimized(inorder []int, postorder []int) *utils.TreeNode {
	if len(inorder) == 0 || len(postorder) == 0 {
		return nil
	}
	...
	var build func(inStart, inEnd, postStart, postEnd int) *utils.TreeNode
	build = func(inStart, inEnd, postStart, postEnd int) *utils.TreeNode {
...
func buildTreeFromInorderPostorder(inorder []int, postorder []int) *utils.TreeNode {
