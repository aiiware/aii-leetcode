...
2. Lowercase function calls that should be uppercase
"""
...
def fix_test_file(filepath):
    ...
    # Fix 2: Replace lowercase function calls with uppercase
    # These are the functions in utils package that are exported (uppercase)
    function_mappings = {
        r'\butils\.sortSubsets\b': 'utils.SortSubsets',
