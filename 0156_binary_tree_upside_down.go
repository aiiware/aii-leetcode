...
func upsideDownBinaryTreeIterative(root *TreeNode) *TreeNode {
...
func upsideDownBinaryTreeDFS(root *TreeNode) *TreeNode {
	return dfsUpsideDown(root, nil, nil)
}

func dfsUpsideDown(node, parent, rightSibling *TreeNode) *TreeNode {
	if node == nil {
		return parent
	}
...
func upsideDownBinaryTreeStack(root *TreeNode) *TreeNode {
	if root == nil || root.Left == nil {
		return root
	}
...
func createTreeFromSlice(values []interface{}) *TreeNode {
