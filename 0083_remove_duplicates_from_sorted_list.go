...
func DeleteDuplicatesWithDummy(head *ListNode) *ListNode {
	if head == nil || head.Next == nil {
		return head
	}
...
func DeleteDuplicatesEarlyExit(head *ListNode) *ListNode {
...
func DeleteDuplicatesStack(head *ListNode) *ListNode {
	if head == nil || head.Next == nil {
		return head
	}
...
func DeleteDuplicatesGeneric(head *ListNode, maxDuplicates int) *ListNode {
