...
func TestPathSum(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			root:   utils.NewTreeFromSlice([]*int{utils.IntPtr(5), utils.IntPtr(4), utils.IntPtr(8), utils.IntPtr(11), nil, utils.IntPtr(13), utils.IntPtr(4), utils.IntPtr(7), utils.IntPtr(2), nil, nil, utils.IntPtr(5), utils.IntPtr(1)}),
			target: 22,
			expected: [][]int{
				{5, 4, 11, 2},
				{5, 8, 4, 5},
