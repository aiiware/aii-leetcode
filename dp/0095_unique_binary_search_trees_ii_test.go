...
func TestGenerateTrees(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "n = 0",
			n:    0,
			validate: func(trees []*utils.TreeNode) bool {
				return len(trees) == 0
			},
		},
		{
...
func isValidBSTHelper95(root *utils.TreeNode, minVal, maxVal int) bool {
	if root == nil {
		return true
	}
...
func containsValues1toN(root *utils.TreeNode, n int) bool {
...
func allTreesUnique(trees []*utils.TreeNode) bool {
...
func treeToString(root *utils.TreeNode) string {
	if root == nil {
		return "null"
	}
...
func countNodesHelper(root *utils.TreeNode) int {
	if root == nil {
		return 0
	}
...
func getAllValuesHelper(root *utils.TreeNode) []int {
	if root == nil {
		return []int{}
	}
