...
func DeleteDuplicatesII(head *utils.ListNode) *utils.ListNode {
...
func DeleteDuplicatesIIRecursive(head *utils.ListNode) *utils.ListNode {
...
func DeleteDuplicatesIITwoPointers(head *utils.ListNode) *utils.ListNode {
	if head == nil || head.Next == nil {
		return head
	}
...
func DeleteDuplicatesIIWithCounter(head *utils.ListNode) *utils.ListNode {
	if head == nil || head.Next == nil {
		return head
	}
...
func DeleteDuplicatesIIEarlyExit(head *utils.ListNode) *utils.ListNode {
...
func DeleteDuplicatesIIStack(head *utils.ListNode) *utils.ListNode {
	if head == nil || head.Next == nil {
		return head
	}
