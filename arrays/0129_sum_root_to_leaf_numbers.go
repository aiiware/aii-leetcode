...
// SumNumbers solves LeetCode problem 0129: Sum Root to Leaf Numbers
// Difficulty: Medium
...
func SumNumbers(root *utils.TreeNode) int {
	...
	var dfs func(node *utils.TreeNode, currentNum int)
	dfs = func(node *utils.TreeNode, currentNum int) {
		if node == nil {
			return
		}
