...
// Time complexity: O(n), Space complexity: O(1)
func partitionListTwoPass(head *ListNode, x int) *ListNode {
	if head == nil {
		return nil
	}
...
// Time complexity: O(n), Space complexity: O(1)
func partitionListInPlace(head *ListNode, x int) *ListNode {
	if head == nil || head.Next == nil {
		return head
	}
	
	// Find the first node >= x
	var beforeX, afterX *ListNode
	var beforeTail, afterTail *ListNode
...
func partitionListRecursive(head *ListNode, x int) *ListNode {
	if head == nil {
		return nil
	}
...
func partitionListOptimized(head *ListNode, x int) *ListNode {
