...
func TestFlatten(t *testing.T) {
	tests := []struct {
		name     string
		root     *utils.TreeNode
		expected *utils.TreeNode
	}{
		{
			name: "Example 1: Complex tree",
			root: utils.NewTreeFromSlice([]*int{
				utils.IntPtr(1), utils.IntPtr(2), utils.IntPtr(5),
				utils.IntPtr(3), utils.IntPtr(4), nil, utils.IntPtr(6),
			}),
			expected: utils.NewTreeFromSlice([]*int{
				utils.IntPtr(1), nil, utils.IntPtr(2), nil, utils.IntPtr(3),
				nil, utils.IntPtr(4), nil, utils.IntPtr(5), nil, utils.IntPtr(6),
			}),
		},
		{
		...
		},
		{
			...
			root:     utils.NewTreeFromSlice([]*int{utils.IntPtr(0)}),
			expected: utils.NewTreeFromSlice([]*int{utils.IntPtr(0)}),
		},
		{
			name: "Example 4: Left-skewed tree",
			root: utils.NewTreeFromSlice([]*int{
				utils.IntPtr(1), utils.IntPtr(2), nil,
				utils.IntPtr(3), nil,
			}),
			expected: utils.NewTreeFromSlice([]*int{
				utils.IntPtr(1), nil, utils.IntPtr(2), nil, utils.IntPtr(3),
		...
		},
		{
			...
			root: utils.NewTreeFromSlice([]*int{
				utils.IntPtr(1), utils.IntPtr(2), utils.IntPtr(3),
				utils.IntPtr(4), utils.IntPtr(5), utils.IntPtr(6), utils.IntPtr(7),
			}),
			expected: utils.NewTreeFromSlice([]*int{
				utils.IntPtr(1), nil, utils.IntPtr(2), nil, utils.IntPtr(4),
				nil, utils.IntPtr(5), nil, utils.IntPtr(3), nil, utils.IntPtr(6), nil, utils.IntPtr(7),
			}),
		},
		{
...
func TestFlatten_EdgeCases(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			root: utils.NewTreeFromSlice([]*int{
				utils.IntPtr(3), utils.IntPtr(2), nil,
				utils.IntPtr(1), nil,
			}),
			expected: utils.NewTreeFromSlice([]*int{
				utils.IntPtr(3), nil, utils.IntPtr(2), nil, utils.IntPtr(1),
			}),
		},
		{
		...
		},
		{
			...
			root: func() *utils.TreeNode {
				...
				vals := make([]*int, 15)
				for i := range vals {
					vals[i] = utils.IntPtr(i + 1)
				}
				return utils.NewTreeFromSlice(vals)
			}(),
			expected: func() *utils.TreeNode {
				// Expected flattened list: 1,2,4,8,9,5,10,11,3,6,12,13,7,14,15
				// This is the pre-order traversal of a complete binary tree
				vals := []*int{
					utils.IntPtr(1), nil, utils.IntPtr(2), nil, utils.IntPtr(4), nil, utils.IntPtr(8),
					nil, utils.IntPtr(9), nil, utils.IntPtr(5), nil, utils.IntPtr(10), nil, utils.IntPtr(11),
					nil, utils.IntPtr(3), nil, utils.IntPtr(6), nil, utils.IntPtr(12), nil, utils.IntPtr(13),
					nil, utils.IntPtr(7), nil, utils.IntPtr(14), nil, utils.IntPtr(15),
				}
				return utils.NewTreeFromSlice(vals)
			}(),
		},
...
func TestFlatten_PreservesValues(t *testing.T) {
	...
	root := utils.NewTreeFromSlice([]*int{
		utils.IntPtr(5), utils.IntPtr(4), utils.IntPtr(8),
		utils.IntPtr(11), nil, utils.IntPtr(13), utils.IntPtr(4),
		utils.IntPtr(7), utils.IntPtr(2), nil, nil, utils.IntPtr(5), utils.IntPtr(1),
	})
...
func copyTree(root *utils.TreeNode) *utils.TreeNode {
	if root == nil {
		return nil
	}
...
func treesEqualFlattened(a, b *utils.TreeNode) bool {
	if a == nil && b == nil {
		return true
	}
	if a == nil || b == nil {
...
func getFlattenedValues(root *utils.TreeNode) []int {
	result := []int{}
	current := root
	for current != nil {
