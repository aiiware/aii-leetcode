...
func ReorderListStack(head *utils.ListNode) {
	if head == nil || head.Next == nil || head.Next.Next == nil {
		return
	}
...
// Time complexity: O(n), Space complexity: O(n)
func ReorderListArray(head *utils.ListNode) {
	if head == nil || head.Next == nil || head.Next.Next == nil {
		return
	}
...
func reverseListHelper(head *utils.ListNode) *utils.ListNode {
...
func mergeLists(first, second *utils.ListNode) {
