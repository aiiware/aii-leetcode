...
func reverseBetweenTwoPass(head *utils.ListNode, left int, right int) *utils.ListNode {
	if head == nil || left == right {
		return head
	}
...
func reverseCompleteList(head *utils.ListNode) *utils.ListNode {
...
func reverseBetweenRecursive(head *utils.ListNode, left int, right int) *utils.ListNode {
	if head == nil || left == right {
		return head
	}
...
func reverseN(head *utils.ListNode, n int) *utils.ListNode {
	if n == 1 {
		return head
	}
...
func reverseBetweenStack(head *utils.ListNode, left int, right int) *utils.ListNode {
	if head == nil || left == right {
		return head
	}
...
func reverseBetweenInPlace(head *utils.ListNode, left int, right int) *utils.ListNode {
	if head == nil || left == right {
		return head
	}
...
func reverseBetweenOptimized(head *utils.ListNode, left int, right int) *utils.ListNode {
	if head == nil {
		return nil
	}
