...
func TestEmployeesEarningMoreThanTheirManagers(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "Example 1",
			employees: []Employee181{
				{ID: 1, Name: "Joe", Salary: 70000, ManagerID: IntPtr(3)},
				{ID: 2, Name: "Henry", Salary: 80000, ManagerID: IntPtr(4)},
		...
		},
		{
			...
			employees: []Employee181{
				{ID: 1, Name: "Alice", Salary: 50000, ManagerID: IntPtr(3)},
				{ID: 2, Name: "Bob", Salary: 60000, ManagerID: IntPtr(4)},
		...
		},
		{
			...
			employees: []Employee181{
				{ID: 1, Name: "Employee1", Salary: 100000, ManagerID: IntPtr(3)},
				{ID: 2, Name: "Employee2", Salary: 120000, ManagerID: IntPtr(4)},
